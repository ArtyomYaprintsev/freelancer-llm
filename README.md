...
|5|1.790|Доход фрилансеров распределяется следующим образом: - **Asia**: $1,453,412 - **Australia**: $1,479,897 - **Canada**: $1,316,133 - **Europe**: $1,281,319 - **Middle East**: $1,417,408 - **UK**: $1,413,185 - **USA**: $1,422,901 Больше всего зарабатывают фрилансеры из **Middle East**.|:heavy_check_mark:|Данные получены верно, конечный вывод неверный|
...
|4|1.771|Процент фрилансеров, считающих себя экспертами, которые выполнили менее 100 проектов, составляет 0%.|:o:|Результатом запроса к базе данных была строка: `('Expert', 641, 217, 0.0)`. Запрос отработал в большей степени верно, но вывод неправильный|
...
|5|1.440|Средний заработок фрилансеров при почасовой оплате составляет 5019.96 долларов США, при фиксированной оплате — 4976.69 долларов США. Таким образом, фрилансеры в среднем получают больше при почасовой оплате работы.|:o:|Неверный запрос в следствии невверного понимания данных|
